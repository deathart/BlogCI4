...
class DatabaseSeeder extends \CodeIgniter\Database\Seeder
{
    ...
    public function run()
    {
        ...
        $this->db->query("INSERT INTO `tags` VALUES(1, 'PHP', 'php')");
        $this->db->query("INSERT INTO `tags` VALUES(2, 'HTML', 'html')");
        $this->db->query("INSERT INTO `tags` VALUES(3, 'CSS', 'css')");
    }
}
